...
export const newRound =  {
    ...
    v49: new EventType(
        ...
        sts.tuple([v49.BlockNumber, v49.RoundIndex, sts.number(), v49.BalanceOf])
    ),
    /**
     * Started new round.
     */
...
export const joinedCollatorCandidates =  {
    ...
    v49: new EventType(
        ...
        sts.tuple([v49.AccountId, v49.BalanceOf, v49.BalanceOf])
    ),
    /**
...
export const nominationIncreased =  {
    ...
    v49: new EventType(
        ...
        sts.tuple([v49.AccountId, v49.AccountId, v49.BalanceOf, v49.BalanceOf])
    ),
    v53: new EventType(
        'ParachainStaking.NominationIncreased',
        sts.tuple([v53.AccountId, v53.AccountId, v53.BalanceOf, sts.boolean(), v53.BalanceOf])
    ),
    v501: new EventType(
        'ParachainStaking.NominationIncreased',
        sts.tuple([v501.AccountId, v501.AccountId, v501.BalanceOf, sts.boolean()])
    ),
}
